...
![alt_text](https://github.com/MariaGrozdeva/Object-oriented_programming_FMI/blob/main/Sem_07/images/Constr.png)

#### Пример за деструктора:
![alt_text](https://github.com/MariaGrozdeva/Object-oriented_programming_FMI/blob/main/Sem_07/images/Destr.png)

#### Пример за копиращия конструктор:
![alt_text](https://github.com/MariaGrozdeva/Object-oriented_programming_FMI/blob/main/Sem_07/images/CopyConstr.png)
...
![alt_text](https://github.com/MariaGrozdeva/Object-oriented_programming_FMI/blob/main/Sem_07/images/ShallowCopy.png)

**Правилното поведение** на копиращия конструктор е следното: :heavy_check_mark:

![alt_text](https://github.com/MariaGrozdeva/Object-oriented_programming_FMI/blob/main/Sem_07/images/RealCopy.png)

## Собствена имплементация на голямата четворка
```c++
// Big 4 ensuring strong exception safety
