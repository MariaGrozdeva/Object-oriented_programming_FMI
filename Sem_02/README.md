...
**Задача 2:** Да се напише функция, която *намира големината на файл* (в байтове).  

**Задача 3**: Да се напише функция, която *връща броя редове във файл*.  

**Задача 4**: Да се напише функция, която *копира съдържанието на файл в друг файл*.  
