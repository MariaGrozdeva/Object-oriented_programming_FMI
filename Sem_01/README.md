...
1. [Указатели и референции](https://github.com/MariaGrozdeva/Introduction_to_programming_FMI/tree/main/Sem_08)

2. Подаване на параметри във функция - по стойност и по референция.  
:bangbang: Подаваме масивите **по константен указател**, ако няма да ги променяме. За примитивните типове **не** използваме const.

3. Връщане на резултат от функция - по стойност и по референция.  
:bangbang: Променливи, инстанции, обекти, създадени вътре в тялото на функцията (и не в динамичната памет), можем да връщаме **само по копие**.
